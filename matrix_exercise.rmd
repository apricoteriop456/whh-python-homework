...
假设A的大小是m*n，B的大小是h*k，则A*B的大小是mh*nk。公式为：
$$A_(m\times n)\bigotimesB_(h\times k)=(\begin{matrix}(a_11\ B&\cdots&a_1n\ B@\vdots&\ddots&\vdots@a_m1\ B&\cdots&a_mn\ B))_(mh\times nk)$$
