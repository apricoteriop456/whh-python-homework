...
fig,ax = plt.subplots() 
ax.plot(all_confirmed.values,color='red',label='确诊',marker='o',markersize=2)
ax.plot(all_recovered.values,color='blue',label='治愈',marker='x',markersize=2)
ax.plot(all_deaths.values,color='lime',label='死亡',marker='*',markersize=2)
...
import matplotlib.ticker as tkr
fig,ax=plt.subplots()
ax.plot(death_rate.values,color='lime',label='死亡率',marker='o',markersize=3)
ax.xaxis.set_major_locator(tkr.MultipleLocator(2.0))
ax.xaxis.set_minor_locator(tkr.MultipleLocator(1.0))
## set the str format of major ticker of X axis
...
```{python fig4,eval=F,fig.cap='湖北省疫情数量',dev="pdf",out.height='20%',out.width='95%'}
#fig=plt.figure()
#ax=plt.subplot()
Mainland_China[Mainland_China.index=='Hubei'].plot(kind = 'barh',color=['red','blue','lime'])#,ax=ax)
plt.xlabel=('数量')
plt.ylabel=('湖北')
plt.tight_layout()
plt.show()
...
fig,ax=plt.subplots()
ax.plot(recovered_rate.values,color='blue',label='治愈率',marker='o',markersize=3)
ax.plot(deaths_rate.values,color='lime',label='死亡率',marker='o',markersize=3)
ax.xaxis.set_major_locator(tkr.MultipleLocator(2.0))
ax.xaxis.set_minor_locator(tkr.MultipleLocator(1.0))
## set the str format of major ticker of X axis
#ax.xaxis.set_major_formatter(tkr.FormatStrFormatter('%m/%d/%y'))
...
fig,ax=plt.subplots()
ax.plot(recover_rate.values,color='blue',label='治愈率',marker='o',markersize=3)
ax.plot(death_rate.values,color='lime',label='死亡率',marker='o',markersize=3)
ax.xaxis.set_major_locator(tkr.MultipleLocator(2.0))
ax.xaxis.set_minor_locator(tkr.MultipleLocator(1.0))
## set the str format of major ticker of X axis
...
```{r fig10,eval=T,echo=F,fig.cap="全球疫情分布图",dev="png",results='markup'}
...
knitr::kable(tab3, row.names =F, align = c(rep("l",5),"c","l"), caption="各个地区疫情治愈情况",
             longtable = TRUE, booktabs = TRUE, linesep  = "")%>%
             kable_styling(latex_options = c("striped", "scale_down", "repeat_header", "hold_position"),repeat_header_text = "(续)")
```
...
knitr::kable(tab4, row.names =F, align = c(rep("l",5),"c","l"), caption="各个地区疫情死亡情况",
             longtable = TRUE, booktabs = TRUE, linesep  = "")
```
...
```{r tab5, eval=T,results='markup', cache=F,echo=F}
library("kableExtra")
library('utils')
